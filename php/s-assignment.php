...
function get_empty_assignments($conn, $student_id) {
    $stmt = $conn->prepare(
        ...
        "LEFT JOIN ASSIGNMENT_FOR_CLASS ON (ASSIGNMENT_FOR_CLASS.ASSIGNMENT_NUMBER = ASSIGNMENT.ASSIGNMENT_NUMBER AND ASSIGNMENT_FOR_CLASS.STUDENT_NUMBER = STUDENT_USER.USER_NUMBER)        " .
