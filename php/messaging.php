...
function get_messages($conn, $class_number, $is_teacher) {
    ...
    if ($is_teacher) {
        $sql =
            "SELECT MESSAGE.MESSAGE_NUMBER, MESSAGE.MESSAGE_TEXT, MESSAGE.MESSAGE_TIMESTAMP, TEACHER_USER.USER_NAME " .
            "FROM MESSAGE " .
            "INNER JOIN EDU_CLASS ON EDU_CLASS.CLASS_NUMBER = MESSAGE.CLASS_NUMBER " .
            "INNER JOIN TEACHER_USER.USER_NUMBER = MESSAGE.TEACHER_USER_NUMBER " .
            "WHERE EDU_CLASS.CLASS_NUMBER = ?;";
    } else {
        $sql =
            "SELECT MESSAGE.MESSAGE_NUMBER, MESSAGE.MESSAGE_TEXT, MESSAGE.MESSAGE_TIMESTAMP, STUDENT_USER.USER_NAME " .
            "FROM MESSAGE " .
            "INNER JOIN EDU_CLASS ON EDU_CLASS.CLASS_NUMBER = MESSAGE.CLASS_NUMBER " .
            "INNER JOIN STUDENT_USER.USER_NUMBER = MESSAGE.STUDENT_USER_NUMBER " .
            "WHERE EDU_CLASS.CLASS_NUMBER = ?;";
    }
